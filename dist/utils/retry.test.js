...
describe('retry', () => {
    ...
    it('fails for non-retryable error', () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(retry_1.retry(makeFn(1, 'abc', false), { n: 3, maxWait: 0, minWait: 0 }).promise).rejects.toThrow('bad failure');
    }));
    it('works after one fail', () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(retry_1.retry(makeFn(1, 'abc'), { n: 3, maxWait: 0, minWait: 0 }).promise).resolves.toEqual('abc');
    }));
    it('works after two fails', () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(retry_1.retry(makeFn(2, 'abc'), { n: 3, maxWait: 0, minWait: 0 }).promise).resolves.toEqual('abc');
    }));
    it('throws if too many fails', () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(retry_1.retry(makeFn(4, 'abc'), { n: 3, maxWait: 0, minWait: 0 }).promise).rejects.toThrow('failure');
    }));
    it('cancel causes promise to reject', () => __awaiter(void 0, void 0, void 0, function* () {
        const { promise, cancel } = retry_1.retry(makeFn(2, 'abc'), { n: 3, minWait: 100, maxWait: 100 });
        cancel();
        yield expect(promise).rejects.toThrow('Cancelled');
    }));
    it('cancel no-op after complete', () => __awaiter(void 0, void 0, void 0, function* () {
        const { promise, cancel } = retry_1.retry(makeFn(0, 'abc'), { n: 3, minWait: 100, maxWait: 100 });
        // defer
        setTimeout(cancel, 0);
    ...
    it('waits random amount of time between min and max', () => __awaiter(void 0, void 0, void 0, function* () {
        const promises = [];
        for (let i = 0; i < 10; i++) {
            promises.push(checkTime(() => expect(retry_1.retry(makeFn(4, 'abc'), { n: 3, maxWait: 100, minWait: 50 }).promise).rejects.toThrow('failure'), 150, 400));
        }
