...
describe('application reducer', () => {
    ...
    describe('setOpenModal', () => {
        it('set wallet modal', () => {
            store.dispatch(actions_1.setOpenModal(actions_1.ApplicationModal.WALLET));
            expect(store.getState().openModal).toEqual(actions_1.ApplicationModal.WALLET);
            store.dispatch(actions_1.setOpenModal(actions_1.ApplicationModal.WALLET));
            expect(store.getState().openModal).toEqual(actions_1.ApplicationModal.WALLET);
            store.dispatch(actions_1.setOpenModal(actions_1.ApplicationModal.CLAIM_POPUP));
            expect(store.getState().openModal).toEqual(actions_1.ApplicationModal.CLAIM_POPUP);
            store.dispatch(actions_1.setOpenModal(null));
