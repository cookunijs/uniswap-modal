...
describe('list reducer', () => {
    ...
    describe('enableList', () => {
        it('enables a list url', () => {
            ...
            store.dispatch(actions_2.enableList('fake-url'));
            expect(store.getState()).toEqual({
                byUrl: {
                    'fake-url': {
                        error: null,
        ...
        it('adds to url keys if not present already on enable', () => {
            ...
            store.dispatch(actions_2.enableList('fake-url-invalid'));
            expect(store.getState()).toEqual({
                byUrl: {
                    'fake-url': {
                        error: null,
    ...
    describe('updateVersion', () => {
        describe('never initialized', () => {
            ...
            it('puts in all the new lists', () => {
                expect(Object.keys(store.getState().byUrl)).toEqual(lists_2.DEFAULT_LIST_OF_LISTS);
            });
            ...
            it('sets initialized lists', () => {
                expect(store.getState().lastInitializedDefaultListOfLists).toEqual(lists_2.DEFAULT_LIST_OF_LISTS);
            });
            it('sets selected list', () => {
                expect(store.getState().activeListUrls).toEqual(lists_1.DEFAULT_ACTIVE_LIST_URLS);
            });
        });
