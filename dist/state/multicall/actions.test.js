...
describe('actions', () => {
    describe('#parseCallKey', () => {
        ...
        it('throws for invalid format', () => {
            expect(() => actions_1.parseCallKey('abc')).toThrow('Invalid call key: abc');
        });
    ...
    describe('#toCallKey', () => {
        it('throws for invalid address', () => {
            expect(() => actions_1.toCallKey({ callData: '0x', address: '0x' })).toThrow('Invalid address: 0x');
        });
        it('throws for invalid calldata', () => {
            expect(() => actions_1.toCallKey({
                address: '0x6b175474e89094c44da98b954eedeac495271d0f',
                callData: 'abc'
