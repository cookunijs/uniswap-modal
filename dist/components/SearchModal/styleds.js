...
exports.TextDot = styled_components_1.default.div `
  ...
  border-radius: 50%;
`;
exports.FadedSpan = styled_components_1.default(Row_1.RowFixed) `
...
exports.Checkbox = styled_components_1.default.input `
  ...
  margin: 0;
`;
exports.PaddedColumn = styled_components_1.default(Column_1.AutoColumn) `
  padding: 20px;
`;
exports.MenuItem = styled_components_1.default(Row_1.RowBetween) `
  padding: 4px 20px;
  height: 56px;
  display: grid;
