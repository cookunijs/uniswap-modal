...
function AdvancedSwapDetailsDropdown(_a) {
    ...
    const lastTrade = useLast_1.useLastTruthy(trade);
    return (react_1.default.createElement(AdvancedDetailsFooter, { show: Boolean(trade) },
        react_1.default.createElement(AdvancedSwapDetails_1.AdvancedSwapDetails, Object.assign({}, rest, { trade: (_b = trade !== null && trade !== void 0 ? trade : lastTrade) !== null && _b !== void 0 ? _b : undefined }))));
}
