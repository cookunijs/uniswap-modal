...
exports.Break = exports.CardSection = exports.CardNoise = exports.CardBGImageSmaller = exports.CardBGImage = exports.DataCard = exports.TextBox = void 0;
...
const noise_png_1 = __importDefault(require("../../assets/images/noise.png"));
...
`;
exports.DataCard = styled_components_1.default(Column_1.AutoColumn) `
...
exports.CardNoise = styled_components_1.default.span `
  background: url(${noise_png_1.default});
  ...
  user-select: none;
`;
exports.CardSection = styled_components_1.default(Column_1.AutoColumn) `
  padding: 1rem;
  z-index: 1;
